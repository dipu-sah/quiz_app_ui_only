...
- [**public**](public)
- [**src**](src)
  - [**@types**](src/@types) (to store shared types)
  - [**API**](src/API) (using dummy file as source but can be replaced with the APIs)
  - [**components**](src/components) (to store all re-usable components)
    - [**layouts**](src/components/layouts) (uncontrolled components)
    - [**UI**](src/components/UI) (controlled components)
  - [**router**](src/router) (react router configurations)
  - [**store**](src/store) (redux tool kit configurations)
  - [**views**](src/views) (router views)
